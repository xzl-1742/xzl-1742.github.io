...
const questions = [
  {
    axis: "CD",
    title: "梦见考试已经开考，你才发现自己一页没看。",
    scene: "卷子厚得像砖，第一题就像从外星寄来的，老师还在旁边盯着你。",
    options: [
      { text: "先扫全卷找能写的题", desc: "梦里也要做损失控制，能捞一分是一分。", trait: "C" },
      { text: "举手质疑考试安排", desc: "先确认科目、座位、人生轨迹，到底是谁把你塞进来的。", trait: "C" },
      { text: "把名字写上开始硬编", desc: "知识没有，笔迹先顶上，写到哪算哪。", trait: "D" },
      { text: "盯着卷子等剧情切走", desc: "反正梦都这样了，看看它接下来还想怎么羞辱你。", trait: "D" },
    ],
  },
  {
    axis: "CD",
    title: "梦见自己马上迟到，电梯每层都停，楼梯还变得没尽头。",
    scene: "时间在狂奔，电梯在慢放，你的灵魂已经开始冒烟。",
    options: [
      { text: "立刻换路线", desc: "楼梯、消防通道、窗户边缘，全都短暂进入你的方案库。", trait: "C" },
      { text: "开始计算还能怎么补救", desc: "迟到理由、进门姿势、甩锅顺序，梦里也要排一下。", trait: "C" },
      { text: "电梯停哪你就去哪", desc: "它爱演就让它演，反正梦会自己负责转场。", trait: "D" },
      { text: "站在原地被时间腌入味", desc: "不是你不急，是你已经被这场梦按住了后脖颈。", trait: "D" },
    ],
  },
  {
    axis: "CD",
    title: "梦见你急着联系一个人，手机却怎么都拨不出去。",
    scene: "屏幕亮着，信号满格，号码一按就变乱码。",
    options: [
      { text: "重输号码重启手机", desc: "把梦里的破手机当成真实故障处理，流程感很强。", trait: "C" },
      { text: "换方式继续联系", desc: "短信、语音、借手机，今天必须把这个人从梦里抠出来。", trait: "C" },
      { text: "怀疑这是剧情设定", desc: "也许梦就是不让你联系，行，它最大。", trait: "D" },
      { text: "把手机揣回兜里", desc: "联系不上就先算了，世界都在做梦，你也别太负责。", trait: "D" },
    ],
  },
  {
    axis: "FE",
  ...
  },
  {
    ...
    options: [
      ...
      { text: "贴墙站着等灯亮", desc: "先别乱走，至少确认脚下这块地还讲道理。", trait: "F" },
      { text: "给墙上做记号继续走", desc: "你不光不撤，还想测试梦到底能复制几层。", trait: "E" },
      { text: "推开最不对劲的门", desc: "门越像有问题，你越觉得它可能藏着主线。", trait: "E" },
    ],
  },
  {
    axis: "FE",
    ...
    options: [
      ...
      { text: "绕开它继续走", desc: "好奇可以有，但这门一看就不是什么正经门。", trait: "F" },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "找个人陪你一起走", desc: "路可以不认识，但最好有人一起不认识。", trait: "A" },
  ...
  },
  {
    ...
    options: [
      ...
      { text: "自己找刹车或逃生口", desc: "不一定懂原理，但你先把命握在自己手里。", trait: "S" },
